...
public class ContactSuggestionFragment extends Fragment implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private final SuggestionViewModel viewModel = new SuggestionViewModel();
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.edit_text_suggestion_type) {
            showMenu(binding.editTextSuggestionType, R.menu.suggestion_menu);
        } else if (id == R.id.button_submit) {
            if ((viewModel.getSuggestionType() == null || viewModel.getSuggestionType().isEmpty())) {

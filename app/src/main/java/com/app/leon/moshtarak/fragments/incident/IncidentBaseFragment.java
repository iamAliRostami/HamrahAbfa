...
import com.app.leon.moshtarak.databinding.FragmentIncidentBaseBinding;
...
public class IncidentBaseFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.image_view_mic_play_pause) {
            if (PermissionManager.checkRecorderPermission(requireContext())) {
                if (ready) {
                    startRecording();
                } else {
                    startPlaying();
            ...
            if (callback.getIncidentViewModel().getIncidentType() == null ||
                ...
                if ((callback.getIncidentViewModel().getDescription() == null ||
                    ...
                    callback.displayView(Constants.INCIDENT_COMPLETE_FRAGMENT);
                }
            }
        }
    }

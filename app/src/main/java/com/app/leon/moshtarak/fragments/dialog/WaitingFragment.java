...
import com.app.leon.moshtarak.databinding.FragmentWaitingBinding;
...
public class WaitingFragment extends DialogFragment {
    ...
    public static WaitingFragment newInstance(ICancelListener cancelListener) {
        ...
        args.putBoolean(BundleEnum.CANCELABLE.getValue(), true);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            cancelable = getArguments().getBoolean(BundleEnum.CANCELABLE.getValue());
            getArguments().clear();
        }
    }

...
import com.app.leon.moshtarak.adapters.recycler_view.CheckoutBillAdapter;
import com.app.leon.moshtarak.adapters.recycler_view.RecyclerItemClickListener;
import com.app.leon.moshtarak.databinding.FragmentCheckoutBillBinding;
    ...
    private void setRecyclerViewListener() {
        final RecyclerItemClickListener listener = new RecyclerItemClickListener(requireContext(),
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra(BundleEnum.ID.getValue(), adapter.getId(position));
                intent.putExtra(BundleEnum.ZONE_ID.getValue(), adapter.getZoneId(position));
